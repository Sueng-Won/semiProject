		...
		<div class="col-lg-9" style='padding-top: 50px; padding-left: 30px;'>
			...
			<table class="list-table">
				<tbody>
					...
					%>
					<tr
						onclick="recruitmentDetail(<%=list.get(i).getRecruitment_id()%>);">
						<td class="table-td">
							<%
						...
						<td class="table-td"><%=list.get(i).getBusiness_type()%></td>
						<td class="td-title"><b><%=list.get(i).getRecruitment_name()%></b><br><%=list.get(i).getRecruitment_title()%></td>
						<td class="table-td-location"><%=location%></td>
						<th class="table-td"><%=list.get(i).getPay()%>원
						</td>
						<td>
